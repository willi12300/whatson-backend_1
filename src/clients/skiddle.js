  ...
  while (true) {
    try {
      ...
      for (const e of results) {
        out.push({
          provider: 'skiddle', providerId: String(e.id),
          name: e.eventname, description: e.description || null,
          ...
          isFree: parseFloat(e.MinPrice || '0') === 0,
      ...
      logger.error('Skiddle failed:', err.message); break
    }
  }
